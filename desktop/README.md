...
Флаги-эмодзи заменены на ISO-бейджи (`CountryBadge`): кружок с кодом страны,
кольцо которого кодирует нагрузку сервера (зелёный→оранжевый→красный),
консистентно с пинами на карте.
